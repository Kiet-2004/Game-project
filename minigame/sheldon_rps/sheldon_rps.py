...
class minigame:
    def __init__(self):
        ...
        self.rock = py.transform.scale(py.image.load('../../assets/minigame/sheldons_rps/rock.png'), (self.width/5, self.height/2))
        self.paper = py.transform.scale(py.image.load('../../assets/minigame/sheldons_rps/paper.png'), (self.width/5, self.height/2))
        self.scissors = py.transform.scale(py.image.load('../../assets/minigame/sheldons_rps/scissors.png'), (self.width/5, self.height/2))
        self.lizard = py.transform.scale(py.image.load('../../assets/minigame/sheldons_rps/lizard.png'), (self.width/5, self.height/2))
        self.spock = py.transform.scale(py.image.load('../../assets/minigame/sheldons_rps/spock.png'), (self.width/5, self.height/2))
