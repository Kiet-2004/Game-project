...
class minigame:
    def __init__(self):
        ...
        self.font = py.font.Font("assets/FreeSansBold.ttf", int(self.height/16))
        self.rock = py.transform.scale(py.image.load('assets/rock.png'), (self.width/5, self.height/2))
        self.paper = py.transform.scale(py.image.load('assets/paper.png'), (self.width/5, self.height/2))
        self.scissors = py.transform.scale(py.image.load('assets/scissors.png'), (self.width/5, self.height/2))
        self.lizard = py.transform.scale(py.image.load('assets/lizard.png'), (self.width/5, self.height/2))
        self.spock = py.transform.scale(py.image.load('assets/spock.png'), (self.width/5, self.height/2))
